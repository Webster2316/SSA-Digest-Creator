            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation">
              <tr>
                ...
                <td class="event-title-cell" valign="top">
                  <p data-f="title" style="margin:0 0 3px;font-family:'Yu Gothic UI',Arial,sans-serif;font-size:16px;font-weight:700;color:#281e7e;line-height:1.3;">${esc(ev.title)}</p>
